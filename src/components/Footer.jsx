            ...
            <div className="footer-container">
                ...
                <div className="footer-column column1">
                    ...
                    <p className="color_footer">
                        With the goal of providing products from internationally
                        renowned luggage brands, offering high-class and quality
                        products at the most reasonable prices for Vietnamese
                        people. Products at House Of Luggage are all genuine,
                        exclusively distributed, and internationally warranted
                        (up to 10 years - or lifetime). They cater to various
                        customer segments, offering diverse designs and colors
                        for your selection.{" "}
                        <a
                            href="https://hol.com.vn"
                            target="_blank"
                ...
                <div className="footer-column column2">
                    ...
                    <p>
                        <span style={{ fontWeight: "700" }}>
                            GLOBAL BAGS & LUGGAGE COMPANY LIMITED
                        </span>
                    </p>
                    <ul className="formatted-list color_footer">
                        <li className="formatted-list-item">
                            Address: L17-11, 17th Floor, Vincom Center Building,
                            72 Le Thanh Ton, District 1, HCMC
                        </li>
                        <li className="formatted-list-item">
                            Phone: 028.3934.5036 - 1800.6063
                        </li>
                        <li className="formatted-list-item">
                            Business Registration Certificate: 0314741857
                        </li>
                        <li className="formatted-list-item">
                ...
                <div className="footer-column column3">
                    ...
                    <div className="hotline_wrap color_footer">
                        ...
                        <strong className="caption_footer">
                            B2B (WHOLESALE):
                        </strong>
                        <div className="margin-top-20 margin-bottom-20">
                            <p className="hotline_item">
                                <i className="fa-solid fa-envelope"></i>{" "}
                                b2b@global-luggage.com.vn
                            </p>
                            <p className="hotline_item">
                                <i className="fa-solid fa-phone"></i> Northern
                                Region: 0909 559 719
                            </p>
                            <p className="hotline_item">
                                <i className="fa-solid fa-phone"></i> Central
                                Region: 0909 880 710
                            </p>
                            <p className="hotline_item">
                                <i className="fa-solid fa-phone"></i> Southern
                                Region: 0938 917 108
                            </p>
                        </div>
                    </div>
